...
public class MsBuildHelper
{
    ...
    //public int RemovePackageReference(string projectPath, string packageName)
    //{
    ...
    private int RemovePackageReference(string projectPath, LibraryDependency libraryDependency)
    {
